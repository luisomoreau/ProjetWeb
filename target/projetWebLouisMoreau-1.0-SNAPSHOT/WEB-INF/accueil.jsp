            ...
            <div class="row selection-blocks">
                <div class="shell4">
                    <div class="block">
                        ...
                        <p class="center">
                            <a href="requalification.jsp" class="button-blue">En savoir plus</a>
                        </p>
                    </div>
                </div>
                <div class="shell4">
                    <div class="block">
                        ...
                        <p class="center">
                            <a href="requalification.jsp" class="center button-blue">En savoir plus</a>
                        </p>
                    </div>
                </div>
                <div class="shell4">
                    <div class="block">
                        ...
                        <p>
                            <a href="materiel-incendie.jsp" class="button-blue">En savoir plus</a>
                        </p>
                    </div>
                </div>
            </div>
