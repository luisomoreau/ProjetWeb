<html><head>
    ...
    <script src="../js/main.js"></script><style type="text/css"></style>
</head>
<body>
<header>
    <div class="row">
...
<div class="row">
    <div class="shell12">
        <div class="shell2 cart">
            ...
            <div class="shell12">
                <p>Récapitulatif de devis (0) :</p>
                <a href="mes-devis.jsp" class="button-blue center">Valider</a>
            </div>
        </div>
        <div class="shell8">
            <div id="product" class="shell4 product">
                ...
                <a class="button-blue" href="produit.jsp">Détails</a>
